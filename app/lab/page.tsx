...
// --- DADOS MOCKADOS (Simulando Supabase) ---
const evidenceData = [
    {
        id: 1,
        title: "Alfabetização e Consciência Fonológica",
        summary: "Estudos longitudinais indicam que o treino explícito de consciência fonológica reduz em 40% a dificuldade de leitura no 1º ano.",
        action: "Implementar 15 min diários de jogos de rimas e aliterações antes da leitura formal.",
        tags: ["Pedagogia", "Alfabetização"],
        validity: "Forte",
        validityColor: "bg-green-100 text-green-800"
    },
    {
        id: 2,
        title: "Distorção Idade-Série e Raça",
        summary: "Dados do SAEB mostram que meninos negros têm 2x mais chance de reprovação por questões não-cognitivas (comportamentais).",
        action: "Revisar critérios de conselho de classe e criar busca ativa focada em vínculos afetivos.",
        tags: ["Gestão", "Equidade Racial"],
        validity: "Promissor",
        validityColor: "bg-blue-100 text-blue-800"
    },
    {
        id: 3,
        title: "Clima Escolar e Aprendizagem",
        summary: "Ambientes onde o estudante se sente seguro emocionalmente aumentam o desempenho em matemática.",
        action: "Instituir rodas de conversa semanais e canal de escuta anônima.",
        tags: ["Clima", "Acolhimento"],
        validity: "Forte",
        validityColor: "bg-green-100 text-green-800"
    }
];
                            ...
                            {evidenceData.map((item) => (
                                <div key={item.id} className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-all flex flex-col h-full">
                                    <div className="flex justify-between items-start mb-4">
                                        <div className={`text-xs font-bold px-3 py-1 rounded-full ${item.validityColor}`}>
